...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Navigation.setNavigationItemSelectedListener {
            when(it.itemId){
                R.id.nav_home -> Toast.makeText(applicationContext,"click navHome", Toast.LENGTH_SHORT).show()
                R.id.nav_community -> Toast.makeText(applicationContext,"click community", Toast.LENGTH_SHORT).show()
                R.id.nav_news -> Toast.makeText(applicationContext,"click news", Toast.LENGTH_SHORT).show()
            }
            true
        }
    }
